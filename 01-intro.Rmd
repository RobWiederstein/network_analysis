...
x <- c("magick", "igraph", "kableExtra", "knitr", "webshot", "tibble")
...
```{r table-adjacency-matrix, echo=F, out.width="65%", fig.align="center", fig.cap="Nodes with adjacency matrix.  [@jasneyIntroductionSocialNetwork2018]"}
...
```{r plot-adjacency-matrix,echo=F, out.width="90%", fig.align="center", fig.cap="Nodes with adjacency matrix", fig.height=5}
...
The function also accepts a sparse matrix which is sometimes preferred to minimize file sizes and conserve system resources on large datasets.
...
```{r plot-edgelist, echo=F, fig.align="center", fig.cap="Plot generated from edgelist.", out.width="90%"}
# create the network object
